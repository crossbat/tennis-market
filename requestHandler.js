...
function redRacket(response){
	fs.readFile('./img/img/redRacket.png', function(err, data){
		response.writeHead(200, {'Content-Type' : 'text/html'});
		response.write(data);
		response.end();
	});
...
function blueRacket(response){
	fs.readFile('./img/img/blueRacket.png', function(err, data){
		response.writeHead(200, {'Content-Type' : 'text/html'});
		response.write(data);
		response.end();
	});
...
function blackRacket(response){
	fs.readFile('./img/img/blackRacket.png', function(err, data){
		response.writeHead(200, {'Content-Type' : 'text/html'});
		response.write(data);
		response.end();
	});
...
handle['/img/img/redRacket.png'] = redRacket;
handle['/img/img/blueRacket.png'] = blueRacket;
handle['/img/img/blackRacket.png'] = blackRacket;
